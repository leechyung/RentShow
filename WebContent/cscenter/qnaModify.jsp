       ...
       <table width="680" border="0" cellpadding="0" cellspacing="0" id="noticeform">
       	<input type="hidden" name = "qboardId" value = "${b.qboardId }">
                      <tr>
                        ...
                        <td width="626">
							<input name="qtitle" id ="titlefield" type="text" size="70" value="${b.qtitle }"></td>
                      </tr>
                      <tr>
                        <th height ="50px">
                        <label for="namefield">작성자</label></th>
                        <td>
                       <input name="quserId" id="namefield" type="text" value="${b.quserId }" readonly></td>
                      </tr>
                      <tr>
                        <th><label for="memo">게시글</label></th>
                        <td height = "300px" valign = "top">
                       <textarea name="qcontent" cols="70" rows="10" id="memo">${b.qcontent }</textarea></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                       <td height="30" colspan="2" align="center" class="btnstyle">
                        <input type="submit" name="send" id="send" value="게시글 수정" style="cursor:pointer">
                        <input type="button" value="리스트 보기" onclick="location.href='qna.jsp'" id ="okbtn">
                        </td>
                      </tr>
	</table>
</form>
