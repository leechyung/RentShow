       ...
       <table width="680" border="0" cellpadding="0" cellspacing="0" id="noticeform">
       	<input type="hidden" name = "nboardId" value = "${n.nboardId }">
                      <tr>
                        ...
                        <td width="626">
							<input name="ntitle" id ="titlefield" type="text" size="70" value="${n.ntitle }"></td>
                      </tr>
                      <tr>
                        <th height ="50px">
                        <label for="namefield">작성자</label></th>
                        <td>
                       <input name="nuserId" id="namefield" type="text" value="${n.nuserId }" readonly></td>
                      </tr>
                      <tr>
                        <th><label for="memo">게시글</label></th>
                        <td height = "300px" valign = "top">
                       <textarea name="ncontent" cols="70" rows="10" id="memo">${n.ncontent }</textarea></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                       <td height="30" colspan="2" align="center" class="btnstyle">
                        <input type="submit" name="send" id="okbtn" value="게시글 수정">
