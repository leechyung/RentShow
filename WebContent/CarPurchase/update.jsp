...
<%
	...
	int cid = Integer.parseInt(multi.getParameter("cid"));
	...
	Car car = new Car(cid, name, price, mfilefield,cfilefield,dfilefield, origin, oil, size, person);
...
%>
    ...
    <div id="noticetop">차량정보수정</div>
  <div id="noticemain">
  <div class="noticement">
  <h3>차량정보가 정상적으로 수정되었습니다.</h3><br><br>
